...
WUXING_ITEMS = {
    "金": ["金属饰品","白色手表","银质项链","圆形镜子","铜铃","白色陶瓷杯","不锈钢水杯"],
    "木": ["绿植盆栽","木质手串","竹制文具","植物精油","绿色笔记本","绿叶图案饰品","棉麻衣物"],
    "水": ["黑色水杯","鱼缸/小鱼","蓝色水晶","墨镜","黑曜石手链","流水摆件","黑色背包"],
    "火": ["红色围巾","蜡烛/香薰","南红玛瑙","红色手机壳","暖光灯","红绳手链","朱砂饰品"],
    "土": ["黄水晶","陶瓷茶具","方形地毯","茶色眼镜","黄玉貔貅","陶土花盆","棕色皮具"],
}
